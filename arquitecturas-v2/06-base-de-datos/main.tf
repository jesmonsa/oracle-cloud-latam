# ╔══════════════════════════════════════════════════════════════════════════════╗
# ║  Main - Base de Datos (Oracle DB System)                                    ║
# ║  Arquitectura: LB + Privados + Bastion + NAT + NFS + DB System            ║
# ║                                                                            ║
# ║  Cambios clave vs Arquitectura 05:                                         ║
# ║    - Oracle DB System en subnet privada dedicada (AD1)                    ║
# ║    - NSG DB habilitado (puerto 1521)                                      ║
# ║    - Subnet privada adicional para la base de datos                       ║
# ║    - Webservers pueden conectarse a la BD via puerto 1521                 ║
# ╚══════════════════════════════════════════════════════════════════════════════╝
...
module "nsgs" {
  ...
  habilitar_nsg_db   = true    # ← DB habilitado para Oracle DB System
...
resource "oci_core_subnet" "db" {
  ...
  display_name               = "${local.prefijo}-subnet-db"
  dns_label                  = "subdb"
  availability_domain        = local.ad_instancia_1
  prohibit_public_ip_on_vnic = true
  route_table_id             = module.red.route_table_privada_id
