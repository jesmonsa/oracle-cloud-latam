# ╔══════════════════════════════════════════════════════════════════════════════╗
# ║  Outputs - Base de Datos (DB System + NFS + LB + Bastion)                   ║
# ╚══════════════════════════════════════════════════════════════════════════════╝
...
output "db_connection_string" {
  description = "Cadena de conexión a la BD (desde los webservers via IP)"
  value       = "${module.database.node_ip}:1521/${module.database.db_name}PDB"
}

output "db_home_id" {
  description = "OCID del DB Home"
...
output "comando_ssh_db" {
  description = "Comando para crear sesión SSH al DB System via Bastion"
...
output "resumen" {
  ...
  value       = <<-EOT
    ╔══════════════════════════════════════════════════════════════╗
    ║  Arquitectura 06 - Base de Datos (Oracle DB System)         ║
    ╠══════════════════════════════════════════════════════════════╣
    ...
    ║  DB  (priv): ${module.database.node_ip} (${local.ad_instancia_1})
