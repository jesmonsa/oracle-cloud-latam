...
variable "vcn_cidr" {
  description = "CIDR block para la Red Virtual Hub (Región 1)"
  type        = string
  default     = "10.0.0.0/16"
}

variable "vcn_spoke_cidr" {
  description = "CIDR block para la Red Virtual Spoke (Región 2)"
  type        = string
  default     = "10.1.0.0/16"
}
...
variable "subnet_db_cidr" {
  description = "CIDR block para la Subred Base de Datos (Región 1)"
  type        = string
  default     = "10.0.3.0/24"
}

variable "subnet_backend_cidr" {
  description = "CIDR block para la Subred Base de Datos (Región 2)"
  type        = string
  default     = "10.1.1.0/24"
}

variable "shape_webserver" {
  description = "Shape Flex para Webserver/Backend: VM.Standard.E4.Flex | E5.Flex | E6.Flex | VM.Standard.x9-15"
  type        = string
...
variable "ocpus_dbsystem" {
  description = "OCPUs para el DB System Primario y Standby (shapes Flex)"
  type        = number
  default     = 2
}

variable "memoria_dbsystem_gb" {
  description = "RAM en GB para el DB System Primario y Standby (shapes Flex). Ignorado en x9-15. Default: 16 GB."
  type        = number
  default     = 16
}
...
variable "imagen_os" {
  description = "OCID de la imagen del sistema operativo de los Webservers (Debe existir en Región 1)"
  type        = string
  default     = ""
}
