...
variable "vcn_cidr" {
  description = "CIDR block para la Red Virtual Hub (VCN Primaria)"
  type        = string
  default     = "10.0.0.0/16"
}

variable "vcn_spoke_cidr" {
  description = "CIDR block para la Red Virtual Spoke (VCN Secundaria)"
  type        = string
  default     = "10.1.0.0/16"
}
...
variable "subnet_db_cidr" {
  description = "CIDR block para la Subred Base de Datos (Hub VCN)"
  type        = string
  default     = "10.0.3.0/24"
}

variable "subnet_backend_cidr" {
  description = "CIDR block para la Subred de Computo Backend (Spoke VCN)"
  type        = string
  default     = "10.1.1.0/24"
}

variable "shape_webserver" {
  description = "Shape Flex para Webserver/Spoke: VM.Standard.E4.Flex | E5.Flex | E6.Flex | VM.Standard.x9-15"
  type        = string
  default     = "VM.Standard.E4.Flex"
}

variable "ocpus_webserver" {
  description = "OCPUs para el Webserver y nodo Spoke (shapes Flex)"
  type        = number
  default     = 1
}

variable "memoria_webserver_gb" {
  description = "RAM en GB para el Webserver y nodo Spoke (shapes Flex). Ignorado en x9-15."
  type        = number
  default     = 8
}
