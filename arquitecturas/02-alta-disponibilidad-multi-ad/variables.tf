...
variable "subnet_publica_ad1_cidr" {
  description = "CIDR block para la Subred Pública AD1"
  type        = string
  default     = "10.0.1.0/24"
}

variable "subnet_publica_ad2_cidr" {
  description = "CIDR block para la Subred Pública AD2"
  type        = string
  default     = "10.0.2.0/24"
}
...
variable "ssh_public_key" {
  description = "Llave pública SSH para conectarse a las instancias"
  type        = string
}
