...
variable "subnet_backend_cidr" {
  description = "CIDR block para la Subred de Computo Backend (Región 2)"
  type        = string
  default     = "10.1.1.0/24"
}
...
variable "ocpus_webserver" {
  description = "OCPUs para el Webserver y nodo Backend (shapes Flex)"
  type        = number
  default     = 1
}

variable "memoria_webserver_gb" {
  description = "RAM en GB para el Webserver y nodo Backend (shapes Flex). Ignorado en x9-15."
  type        = number
  default     = 8
}
